...
function Profile() {
  ...
  return (
    <>
      ...
      <div className="">
        <div className="p-8 bg-white shadow mt-4 w-full">
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="grid grid-cols-3 text-center order-last md:order-first mt-20 md:mt-0" />
            <div className="">
              {isLoading || error ? <div className="animate-pulse rounded-full bg-slate-200 h-24 w-24 mx-auto shadow-2xl flex items-center justify-center" />
                : (
          ...
          <div className="mt-12 flex flex-col justify-center">
            {isLoading ? <div className="animate-pulse h-10 bg-slate-200 rounded" />
